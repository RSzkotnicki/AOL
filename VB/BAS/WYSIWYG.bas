...
Public Function WYSIWYG_RTF(RTF As RichTextBox, LeftMarginWidth As Long, RightMarginWidth As Long) As Long
    ...
    Call SendMessage(RTF.hWnd, EM_SETTARGETDEVICE, PrinterhDC, ByVal LineWidth)
...
Public Sub PrintRTF(RTF As RichTextBox, LeftMarginWidth As Long, TopMarginHeight, RightMarginWidth, BottomMarginHeight)
    ...
    Do
        ...
        If (NextCharPosition > TextLength) Then
            fr.chrg.cpMax = TextLength    '---- If done then exit
        End If
    ...
    Call SendMessage(RTF.hWnd, EM_FORMATRANGE, False, ByVal CLng(0))
