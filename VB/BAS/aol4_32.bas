...
'America Online 4.0 Bas File Put To Gether by Soap
'Go to http://members.aol.com/osoapo/
'Programed by Soap , -=Zig=- and S/\/oW also thanx
'Proggie for the help...

'i Soap am in no way responsible for the ways this
'file are used plese dont go off on me for making
'this like its corny or somthing i had good
'intentions

'if you can contribute to this bas file plese
'do and send them to me i would Gratly apreaciate
'it i really need a better send IM code
'Go to where i post all this bas updates
'http://members.aol.com/osoapo/
'E-mail me osoapo@aol.com
